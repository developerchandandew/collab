...
const Join=()=>{
    return(
        ...
        <div className="w-full bg-[url('images/join-bg.jpeg')] bg-cover bg-no-repeat relative h-[80vh] ">
            <img src="images/join-bg.jpeg" alt="join page" className="absolute top-0 left-0 z-0" />
            <div className="hidden md:w-full md:h-full md:bg-gradient-to-r from-[#1C7C9C] to-[#1C7C9C2B] opacity-[0.8] absolute top-0 left-0 md:block -z-10"></div>
